  ...
  CREATE TABLE "B_AUDYT_KONTROLA" 
   (	"ID_PK_B_AUDYT_KONTROLA" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"CZY_ANKIETA_WYGENEROWANA" NUMBER DEFAULT 0, 
  ...
  ;
   ...
   COMMENT ON COLUMN "B_AUDYT_KONTROLA"."CZY_ANKIETA_WYGENEROWANA" IS 'Flaga: 0=ankieta nie wygenerowana, 1=rekordy B_ANKIETA i B_OCENA istnieja';
...
create or replace PACKAGE PKG_ANKIETA AS
    -- Generuje ankiete (B_ANKIETA) i oceny (B_OCENA) dla pary audyt+kontrola.
    -- Idempotentna – jesli flaga CZY_ANKIETA_WYGENEROWANA = 1, nie robi nic.
    -- Wykonuje COMMIT na koncu (po wzorcu z PKG_AUDYT).
    PROCEDURE GENERUJ_ANKIETE (
        p_id_audytu     IN NUMBER,
        p_id_kontrola   IN NUMBER
    );
    -- Usuwa ankiete (B_ANKIETA) i oceny (B_OCENA) dla pary audyt+kontrola.
    -- NIE wykonuje COMMIT – wywolujacy odpowiada za transakcje
    -- (typowo: PKG_AUDYT.USUN_KONTROLE zrobi COMMIT po usunieciu z B_AUDYT_KONTROLA).
...
/
   ...
   CREATE SEQUENCE  "DAW_SEQ_B_C_ANAKIETA_PK"  MINVALUE 0 MAXVALUE 9999999 INCREMENT BY 1 START WITH 1275 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;

   CREATE SEQUENCE  "DAW_SEQ_B_C_ODPOWIEDZ_PK"  MINVALUE 0 MAXVALUE 9999999 INCREMENT BY 1 START WITH 212 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
